 ...
 *
 * $Id: functions_filetypes.php,v 1.3 2005/01/15 23:24:26 acydburn Exp $
 ***************************************************************************/
...
function image_getdimension($file)
{
    ...
    if ('BM' == $tmp_str) {
        ...
        if (!$error) {
            ...
            if ((0x3E != $i) && (0x76 != $i) && (0x436 != $i) && (0x36 != $i)) {
                $error = true;
            }
        }
    ...
    if ('GIF' == $tmp_str) {
        ...
        if ((0x80 != ($info_byte & 0x80)) && (0 != ($info_byte & 0x80))) {
            $error = true;
        }
    ...
    if (((10 == ord($tmp_str[0]))) && ((0 == ord($tmp_str[1])) || (2 == ord($tmp_str[1])) || (3 == ord($tmp_str[1])) || (4 == ord($tmp_str[1])) || (5 == ord($tmp_str[1]))) && ((1 == ord($tmp_str[2])))) {
        $b = fread($fp, 1);

        if ((1 != ord($b)) && (2 != ord($b)) && (4 != ord($b)) && (8 != ord($b)) && (24 != ord($b))) {
            $error = true;
        }
...
{
    if ((function_exists('gzuncompress')) && (swf_tag_compressed == mb_substr($buffer, 0, 3)) && (ord(mb_substr($buffer, 3, 1)) >= 6)) {
...
function swf_getdimension($file)
{
    ...
    if ((swf_tag_identify == mb_substr($buffer, 0, 3)) || (swf_tag_compressed == mb_substr($buffer, 0, 3))) {
