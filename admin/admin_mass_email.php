 ...
 *
 * $Id: admin_mass_email.php,v 1.15.2.7 2005/05/03 23:24:01 acydburn Exp $
 ****************************************************************************/
...
if (isset($_POST['submit'])) {
    ...
    $sql = (-1 != $group_id) ? 'SELECT u.email FROM ' . USERS_TABLE . ' u, ' . USER_GROUP_TABLE . " ug WHERE ug.group_id = $group_id AND ug.user_pending <> " . true . ' AND u.uid = ug.user_id' : 'SELECT email FROM ' . USERS_TABLE;
    ...
    if ($row = $db->sql_fetchrow($result)) {
        ...
        $message = (-1 != $group_id) ? $lang['Group_not_exist'] : $lang['No_such_user'];
