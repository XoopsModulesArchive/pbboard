 ...
 *
 * $Id: index.php,v 1.40.2.4 2005/02/28 16:39:34 acydburn Exp $
 ***************************************************************************/
...
'GZIP_COMPRESSION' => ($board_config['gzip_compress']) ? $lang['ON'] : $lang['OFF'],
    ...
    $sql = 'SELECT u.uid, u.uname, u.user_session_time, u.user_session_page, s.session_logged_in, s.sess_ip, s.session_start
...
ORDER BY u.user_session_time DESC';
    ...
    $sql = 'SELECT session_page, session_logged_in, sess_updated, sess_ip, session_start
FROM ' . SESSIONS_TABLE . '
WHERE session_logged_in = 0
AND sess_updated >= ' . (time() - 300) . '
ORDER BY sess_updated DESC';
...
'U_USER_PROFILE' => append_sid("admin_users.$phpEx?mode=edit&amp;" . POST_USERS_URL . '=' . $onlinerow_reg[$i]['uid']),
