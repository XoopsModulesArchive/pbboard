 ...
 *
 * $Id: admin_board.php,v 1.51.2.6 2005/06/10 00:37:12 psotfx Exp $
 ***************************************************************************/
define('IN_PHPBB', 1);
if (!empty($setmodules)) {
    $file = basename(__FILE__);

    $module['General']['Configuration'] = (string)$file;
...
$activation_none = (USER_ACTIVATION_NONE == $new['require_activation']) ? 'checked="checked"' : '';
$activation_user = (USER_ACTIVATION_SELF == $new['require_activation']) ? 'checked="checked"' : '';
$activation_admin = (USER_ACTIVATION_ADMIN == $new['require_activation']) ? 'checked="checked"' : '';
