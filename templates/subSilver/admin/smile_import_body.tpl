...
<tr>
<td class="row2" colspan="2" align="center">{L_CONFLICTS}<br><input type="radio" name="replace" value="1" checked> {L_REPLACE_EXISTING} &nbsp; <input type="radio" name="replace" value="0"> {L_KEEP_EXISTING}</td>
</tr>
<tr>
