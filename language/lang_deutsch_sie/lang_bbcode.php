...
/***************************************************************************
 * lang_bbcode.php [deutsch - Formal]
 * -------------------
...
$faq[] = ['--', 'Andere Codes'];
$faq[] = ['Kann ich meine eigenen Tags benutzen?', 'Nein, nicht mit phpBB2.0 direkt! Wir versuchen, eine Möglichkeit zu finden, dies zu unterstützen und vielleicht gibt es die Funktion dann in einer der nächsten Versionen'];
//
